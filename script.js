...
<h3 class="featureheadline">${projectContainerArr[0].headline}</h3>
        <div class="feature-speaker-container">
          <div class="speaker1">
            <img id="profile-img1" src= "${projectContainerArr[0].image}"alt="profile-image" />
          ...
          <div class="speaker2">
            <img id="profile-img2" src="${projectContainerArr[1].image}"alt="profile-image" />
          ...
          <img id="profile-img2" src="${projectContainerArr[2].image}"alt="profile-image" />
          <div id="speaker-profile2">
          ...
          <div class="speaker4 view-more">
            <img id="profile-img2" src="${projectContainerArr[3].image}"alt="profile-image" />
            <div id="speaker-profile2">
          ...
          <img id="profile-img2" src="${projectContainerArr[4].image}"alt="profile-image" />
          <div id="speaker-profile2">
          ...
          <img id="profile-img2" src="${projectContainerArr[5].image}"alt="profile-image" />
          <div id="speaker-profile2">
        ...
        <button id="see-more-btn" type="button">More<span id="see-more" class="material-symbols-outlined">
            expand_more
        </span></button>
        `;
}
